...
/**
 * Query workflow execution by getting history from Cadence and executing it on a local worker. Use
 * this approach to debug workflow execution in a local environment.
 *
 * @author fateev
 */
